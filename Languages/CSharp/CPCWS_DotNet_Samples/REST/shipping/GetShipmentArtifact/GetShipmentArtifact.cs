...
namespace GetShipmentArtifact
{
    class GetShipmentArtifact
    {
        static void Main(string[] args)
        {
            ...
            // REST URL - ers
            // var url = "https://ct.soa-gw.canadapost.ca/ers/artifact/" + username + "/10238/0";

            // REST URL - rs
            var url = "https://ct.soa-gw.canadapost.ca/rs/artifact/" + username + "/10238/0";
