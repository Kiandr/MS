...
* 
* The GetShipment service is used to retrieve the same links originally 
* provided by create shipment (used for recovery).
*
...
namespace GetShipment
{
    class GetShipment
    {
        static void Main(string[] args)
        {
            ...
            // REST URI
            var url = "https://ct.soa-gw.canadapost.ca/rs/" + mailedBy + "/" + mobo + "/shipment/340531309186521749";
            ...
            try
            {
                ...
                // Deserialize xml response to ShipmentInfoType object
