/**
* Sample code for the CreateNonContractShipment Canada Post service.
* 
...
namespace CreateNCShipment
{
    class CreateNCShipment
    {
        static void Main(string[] args)
        {
            ...
            var url = "https://ct.soa-gw.canadapost.ca/rs/" + mailedBy + "/ncshipment"; // REST URL
            ...
            try
            {
                ...
                XmlSerializer serializerRequest = new XmlSerializer(typeof(NonContractShipmentType));
