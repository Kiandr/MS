/**
* Sample code for the GetNonContractShipmentDetails Canada Post service.
* 
* The GetNonContractShipmentDetails service is used to retrieve XML details about the 
* shipping label, including system-generated values such as the tracking number 
* and final shipping point. 
*
...
namespace GetNCShipmentDetails
{
    class GetNCShipmentDetails
    {
        static void Main(string[] args)
        {
            ...
            // REST URI
            var url = "https://ct.soa-gw.canadapost.ca/rs/" + mailedBy + "/ncshipment/406951321983787352/details";
            ...
            try
            {
                ...
                // Deserialize xml response to NCShipmentDetailsType object
                XmlSerializer serializer = new XmlSerializer(typeof(NonContractShipmentDetailsType));
                TextReader reader = new StreamReader(response.GetResponseStream());
                NonContractShipmentDetailsType shipmentDetails = (NonContractShipmentDetailsType)serializer.Deserialize(reader);

                // Retrieve values from NCShipmentDetailsType object
