/**
* Sample code for the GetNonContractShipments Canada Post service.
* 
* The GetNonContractShipments service invokes a search for previously created 
* shipments. It is used to recover from communication failures or hardcopy print 
* failures.  
*
...
namespace GetNCShipments
{
    class GetNCShipments
    {
        static void Main(string[] args)
        {
            ...
            // REST URI
            var url = "https://ct.soa-gw.canadapost.ca/rs/" + mailedBy + "/ncshipment?from=201202010000&to=201203010000";
            ...
            try
            {
                ...
                // Deserialize xml response to NCShipmentsType object
                XmlSerializer serializer = new XmlSerializer(typeof(NonContractShipmentsType));
                TextReader reader = new StreamReader(response.GetResponseStream());
                NonContractShipmentsType shipments = (NonContractShipmentsType)serializer.Deserialize(reader);

                // Retrieve values from NCShipmentsType object
