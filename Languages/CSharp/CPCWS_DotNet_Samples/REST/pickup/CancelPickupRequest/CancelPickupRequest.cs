...
/**
 * Sample code for the CancelPickupRequest Canada Post service.
 * 
 * The CancelPickupRequest service cancels (deletes) an existing pickup request.
 * 
 * This sample is configured to access the Developer Program sandbox environment. 
 * Use your development key username and password for the web service credentials.
 * 
 */
namespace CancelPickupRequest
{
    class CancelPickupRequest
    {
        static void Main(string[] args)
        {
            ...
            var url = "https://ct.soa-gw.canadapost.ca/enab/" + customerNumber + "/pickuprequest/0074698052"; // REST URL
            ...
            try
            {
                ...
                {
                    responseAsString += "Pickup Request successfully cancelled.\r\n";
                }
