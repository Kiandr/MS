/**
* Sample code for the RetrieveNextOpenReturnArtifact Canada Post service.
* 
* The RetrieveNextOpenReturnArtifact service is used to retrieve the PDF image of
* a return label artifact that was pre-established using Create Open Return
* Template.
*
...
namespace RetrieveNextOpenReturnArtifact
{
    class RetrieveNextOpenReturnArtifact
    {
        static void Main(string[] args)
        {
            ...
            var url = "https://ct.soa-gw.canadapost.ca/rs/" + mailedBy + "/" + mobo + "/openreturn/349641323786705649/artifact";
            ...
            try
            {
                ...
                String fileName = "openReturnArtifact.pdf";
                if (mediaStr.Equals("application/zpl"))
                {
                    fileName = "openReturnArtifact.zpl";
                }
