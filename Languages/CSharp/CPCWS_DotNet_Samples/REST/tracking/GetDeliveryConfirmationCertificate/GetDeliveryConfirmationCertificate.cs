...
namespace GetDeliveryConfirmationCertificate
{
    class GetDeliveryConfirmationCertificate
    {
        static void Main(string[] args)
        {
            ...
            var url = "https://ct.soa-gw.canadapost.ca/vis/certificate/1371134583769923"; // REST URL
            ...
            try
            {
                ...
                // Deserialize xml response to deliveryconfirmationcertificate object
                XmlSerializer serializer = new XmlSerializer(typeof(deliveryconfirmationcertificate));
                TextReader reader = new StreamReader(response.GetResponseStream());
                deliveryconfirmationcertificate certifcate = (deliveryconfirmationcertificate)serializer.Deserialize(reader);
